...
<head>
    ...
    <title>IPA Admin Panel - Departement</title>
    <!-- base:css -->
...
<body>
    <div class="container-scroller">
            ...
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand brand-logo" href="admin.html">
                        <img src="./img/logo-white-ipa.png" alt="logo" style=" width: 50px;" alt="logo" /></a>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <!-- partial -->
            <?php include './partials/model-add-dep.php'; ?>
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <button type='button' data-toggle='modal' data-target='#add-departement'
                            class='btn mb-3 ml-3 btn-inverse-success btn-fw'> Ajoute departement</button>
    ...
    <script>
        ...
        var table = new Tabulator("#example-table", {
            ajaxURL: "src/departement.php", //ajax URL
            height: 633,
            ...
            columns: [ //Define Table Columns
                ...
                {
                    title: "libelle",
                    field: "libelleDepartement",
                    width: 150
                },
                {
                    title: "Code de Departement",
