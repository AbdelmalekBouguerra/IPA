...
<html lang="en">
  ...
  <?php include "partials/navbar.html"?>
      ...
      <section class="breadcrumb_area">
        ...
        <img
          class="p_absolute wave_shap_one"
          src="img/blog-classic/shap_01.png"
          alt=""
        />
        <img
          class="p_absolute wave_shap_two"
          src="img/blog-classic/shap_02.png"
          alt=""
        />
        <img
          class="p_absolute one wow fadeInRight"
          src="img/home_one/b_man_two.png"
          alt=""
        />
        <img
          class="p_absolute two wow fadeInUp"
          data-wow-delay="0.2s"
          ...
          <div class="row">
            <div class="col-lg-8">
              ...
              <div class="answer-action">
                <div class="action-content">
                  <div class="image-wrap">
                    <img
                      src="img/home_support/answer.png"
                      alt="answer action"
                    />
                  </div>
              ...
              <div class="community-posts-wrapper bb-radius">
                    ...
                    <div class="entry-content">
                      <h3 class="post-title">
                        <a href="forum-single.html"
                          >Workspace/Org Administration</a
                        >
                      </h3>
                      <ul class="meta">
                        <li>
                ...
                <div
                  class="community-post style-two improvement kbDoc open druid"
                >
                  <div class="post-content">
                    <div class="author-avatar">
                      <img
                        src="img/home_support/cp1.png"
                        alt="community post"
                      />
                    </div>
                    <div class="entry-content">
                      <h3 class="post-title">
                        <a href="forum-single.html"
                          >Course do not display properly</a
                        >
                      </h3>
                      <div class="cat-wrap">
                      ...
                      <ul class="meta">
                        <li>
                          <img src="img/home_support/cmm2.png" alt="cmm" /><a
                            href="#"
                            >WordPress Theme</a
                          >
                        </li>
                ...
                <div
                  class="community-post style-two css feature improvement weir"
                >
                  <div class="post-content">
                    <div class="author-avatar">
                      <img
                        src="img/home_support/cp3.jpg"
                        alt="community post"
                      />
                    </div>
                    <div class="entry-content">
                      <h3 class="post-title">
                        <a href="forum-single.html"
                          >How to add a different logo image to the NON Sticky
                          header?</a
                        >
                      </h3>
                      <ul class="meta">
                        <li>
                          <img src="img/home_support/cmm3.png" alt="cmm" /><a
                            href="#"
                            >WordPress Theme</a
                          >
                        </li>
                ...
                <div
                  class="community-post style-two feature kbDoc spider richard"
                >
                  <div class="post-content">
                    <div class="author-avatar">
                      <img
                        src="img/home_support/cp4.jpg"
                        alt="community post"
                      />
                    </div>
                    <div class="entry-content">
                      ...
                      <ul class="meta">
                        <li>
                          <img src="img/home_support/cmm4.png" alt="cmm" /><a
                            href="#"
                            >WordPress Theme</a
                          >
                        </li>
                ...
                <div class="community-post style-two spider open weir">
                  <div class="post-content">
                    ...
                    <div class="entry-content">
                      ...
                      <ul class="meta">
                        <li>
                          <img src="img/home_support/cmm5.png" alt="cmm" /><a
                            href="#"
                            >WordPress Theme</a
                          >
                        </li>
                ...
                <div
                  class="community-post style-two bug feature doc open druid dylan"
                >
                  <div class="post-content">
                    <div class="author-avatar">
                      <img
                    ...
                    <div class="entry-content">
                      ...
                      <ul class="meta">
                        <li>
                          <img src="img/home_support/cmm6.png" alt="cmm" /><a
                            href="#"
                            >WordPress Theme</a
                          >
                        </li>
                        <li>
                          <i class="icon_calendar"></i>updated 6 days agoe
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div
                  class="community-post style-two spider doc open giles fletch"
                >
                  <div class="post-content">
                    <div class="author-avatar">
                      <img
                    ...
                    <div class="entry-content">
                      ...
                      <ul class="meta">
                        <li>
                          <img src="img/home_support/cmm7.png" alt="cmm" /><a
                            href="#"
                            >WordPress Theme</a
                          >
                        </li>
                ...
                <div class="community-post style-two kbDoc bug open dylan">
                  <div class="post-content">
                    ...
                    <div class="entry-content">
                      ...
                      <ul class="meta">
                        <li>
                          <img src="img/home_support/cmm8.png" alt="cmm" /><a
                            href="#"
                            >WordPress Theme</a
                          >
                        </li>
                ...
                <div class="community-post style-two giles mann">
                  <div class="post-content">
                    ...
                    <div class="entry-content">
                      ...
                      <ul class="meta">
                        <li>
                          <img src="img/home_support/cmm9.png" alt="cmm" /><a
                            href="#"
                            >WordPress Theme</a
                          >
                        </li>
                ...
                <div class="community-post style-two theodore fletch">
                  <div class="post-content">
                    ...
                    <div class="entry-content">
                      <h3 class="post-title">
                        <a href="forum-single.html"
                          >Change “courses” in URL permalink base</a
                        >
                      </h3>
                      <div class="cat-wrap">
                ...
                <div class="community-post style-two mann">
                  <div class="post-content">
                    ...
                    <div class="entry-content">
                      <h3 class="post-title">
                        <a href="forum-single.html"
                          >Disable animations for ui testing</a
                        >
                      </h3>
                      <ul class="meta">
                        <li>
                ...
                <div class="community-post style-two theodore">
                  <div class="post-content">
                    ...
                    <div class="entry-content">
                      <h3 class="post-title">
                        <a href="forum-single.html"
                          >Lightbox zoom on mobile device</a
                        >
                      </h3>
                      <div class="cat-wrap">
                        <a class="badge color-green" href="#">Feature</a>
                      ...
                      <ul class="meta">
                        <li>
                          <img src="img/home_support/cmm11.png" alt="cmm" /><a
                            href="#"
                            >WordPress Theme</a
                          >
                        </li>
              ...
              <div class="forum_sidebar">
                ...
                <div class="widget ticket_widget">
                  ...
                  <ul class="list-unstyled ticket_categories">
                    <li>
                      <img src="img/home_support/cmm5.png" alt="category" /><a
                        href="#"
                        >Docs WordPress Theme</a
                      >
                      <span class="count">10</span>
                    </li>
                    <li>
                      <img src="img/home_support/cmm4.png" alt="category" /><a
                        href="#"
                    ...
                    <li>
                      <img src="img/home_support/cmm2.png" alt="category" /><a
                        href="#"
                        >Knowledge base Template</a
                      ><span class="count">142</span>
                    </li>
                    <li>
                      <img src="img/home_support/cmm8.png" alt="category" /><a
                        href="#"
                        >Startup and App WP Theme</a
                      >
                      <span class="count">13</span>
                    </li>
                    <li>
                      <img src="img/home_support/cmm9.png" alt="category" /><a
                        href="#"
                        >Clean Email Template</a
                      >
                      <span class="count">123</span>
                    </li>
                    <li>
                      <img src="img/home_support/cmm10.png" alt="category" /><a
                        href="#"
                        >Apps WordPress Theme</a
                      >
        ...
        <div class="container">
          <div class="action-content-wrapper">
            ...
            <a href="#" class="action_btn"
              >Join the community <i class="arrow_right"></i
            ></a>
          </div>
      ...
      <footer class="footer_area f_bg_color">
        ...
        <img
          class="p_absolute f_man wow fadeInRight"
          data-wow-delay="0.6s"
        ...
        <img
          class="p_absolute f_email"
          src="img/home_two/email-icon.png"
          alt=""
        />
        <img
          class="p_absolute f_email_two"
          src="img/home_two/email-icon_two.png"
          alt=""
        />
        <img
          class="p_absolute f_man_two wow fadeInLeft"
          data-wow-delay="0.3s"
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-3 col-sm-6">
                <div
                  class="f_widget link_widget pl_30 wow fadeInUp"
                  data-wow-delay="0.2s"
                >
              ...
              <div class="col-lg-2 col-sm-6">
                <div
                  class="f_widget link_widget wow fadeInUp"
                  data-wow-delay="0.4s"
                >
              ...
              <div class="col-lg-3 col-sm-6">
                <div
                  class="f_widget link_widget pl_70 wow fadeInUp"
                  data-wow-delay="0.6s"
                >
