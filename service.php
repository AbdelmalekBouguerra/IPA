...
<head>
    ...
    <title>IPA Admin Panel - Service</title>
    <!-- base:css -->
...
<body>
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <!-- partial -->
            <?php include './partials/model-add-ser.php'; ?>
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <button type='button' data-toggle='modal' data-target='#add-service'
                            class='btn mb-3 ml-3 btn-inverse-success btn-fw'> Ajoute service</button>
    ...
    <script>
        ...
        var table = new Tabulator("#example-table", {
            ajaxURL: "src/service.php", //ajax URL
            height: 633,
            ...
            columns: [ //Define Table Columns
                ...
                {
                    title: "id Departement",
                    field: "idDepartement",
                    width: 150
                },
                {
                    title: "libelle",
                    field: "libelleService",
                    width: 150
                },
                {
